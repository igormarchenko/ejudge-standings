...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/api/frozen-submits/**").access("hasAnyAuthority('ROLE_ADMIN', 'ROLE_OBSERVER')")
                .antMatchers("/api/baylor-export/**").access("hasAnyAuthority('ROLE_ADMIN', 'ROLE_OBSERVER')")
